      ...
      lib.types.submodules.portable {
        module = (
          ...
          let
            ...
            result = if builtins.isNull validity then builder.build package else { };
          in
          {
            options = {
                ...
                default.value =
                  if builtins.isNull validity then
                  ...
                  else
                    {
                      ...
                      message =
                        validity.message
                          or "package \"${name}\" failed to build due to either invalid settings or an invalid builder.";
                    };
              };
